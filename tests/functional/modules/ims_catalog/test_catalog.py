...
def test_catalog_create_datasets_01(ansible_zos_module):
   ...
   response = hosts.all.zos_data_set(name="IMSTESTL.IMS1.DFSCD000.DI1001", state="present", volume="USER03", space_primary="200")

def test_catalog_create_datasets_02(ansible_zos_module):
   hosts = ansible_zos_module
   response = hosts.all.zos_data_set(name="IMSTESTL.IMS1.DFSCD000.DI1002", state="present", volume="USER03", space_primary="200")
