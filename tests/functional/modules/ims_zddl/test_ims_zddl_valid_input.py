...
# 8. Create Program view with simulation and auto-commit: Variation of the control statements variables
...
# 10. IRLM Specified: Checks that when OFFLINE, works when IRLM_ID is provided (DLI test case)
...
# 11. Offline simulation (DLI test case): Variation of control statements variable for an OFFLINE scenario
