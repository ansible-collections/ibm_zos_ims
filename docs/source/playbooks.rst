...
.. _sample configuration and setup:
   https://ansible-collections.github.io/ibm_zos_ims/playbooks.html#sample-configuration-and-setup
.. _sample playbooks:
   https://github.com/ansible-collections/ibm_zos_ims/tree/master/playbooks
...
``ansible-playbook -i inventory ims-collection-sample.yaml --ask-pass``.
