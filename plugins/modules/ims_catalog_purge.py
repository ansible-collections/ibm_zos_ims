...
options:
  ...
  sysut1:
    description:
      - Specify the SYSUT1 dataset here. This dataset is where all DELETE statements generated by ANALYSIS or BOTH
        are located.
    type: dict
    required: false
    suboptions:
...
def run_module():
    module_args = dict(
      ...
      update_retention_criteria=dict(type="dict", required=False),
