The following is a sample batch input of IMS DBRC commands:
```
ims_dbrc:
    batch:
        -
        ...
        -
            ...
            dbdlib: IMSTESTL.IMS1.DBDLIB
```
There are two options for the corresponding output of the above sample batch input.

One variation of the output would be to simply take the return string, split the string line by line, and return the output as an array of strings. This is shown below in the `data` field.
```
{
    "changed": "true"
    "failed": "false"
...
The second option is to parse the output and map the data to it's corresponding field.
```
{
    "changed": "true"
    "failed": "false"
